...
class MockEvaluationResult:
    ...
    This is a lightweight mock of the full EvaluationResult class from heal.py,
...
def test_deescalation_logic():
    ...
    result = MockEvaluationResult(url_f1=0.8, context_relevance=0.8, answer_correctness=0.9)
    ...
    poor_result = MockEvaluationResult(
        url_f1=0.3, context_relevance=0.5, answer_correctness=0.6  # Too low  # Too low  # Too low
    )
    ...
    deescalate = agent.should_deescalate_model(
        "complex", borderline_result, consecutive_successes=2
    )
